...
export const IconUsers = (p) => (<S {...p}><path d="M17 21v-2a4 4 0 0 0-4-4H7a4 4 0 0 0-4 4v2" /><circle cx="10" cy="7" r="4" /><path d="M21 21v-2a4 4 0 0 0-3-3.87" /><path d="M16 3.13a4 4 0 0 1 0 7.75" /></S>);
export const IconSearch = (p) => (<S {...p}><circle cx="11" cy="11" r="7" /><path d="m21 21-4.3-4.3" /></S>);
export const IconMenu = (p) => (<S {...p}><path d="M4 7h16M4 12h16M4 17h16" /></S>);
export const IconClose = (p) => (<S {...p}><path d="M18 6 6 18M6 6l12 12" /></S>);
export const IconChevronDown = (p) => (<S {...p}><path d="m6 9 6 6 6-6" /></S>);
export const IconHome = (p) => (<S {...p}><path d="m3 10 9-7 9 7v10a1 1 0 0 1-1 1h-5v-6h-6v6H4a1 1 0 0 1-1-1Z" /></S>);
