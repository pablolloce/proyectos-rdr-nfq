...
// Las variantes sólidas usan HEX LITERALES (superficie idéntica en ambos temas):
// con utilidades temadas, en claro el fondo se oscurecería y el texto Electric
// dejaría de contrastar. danger/ghost sí usan utilidades temadas (glass).
const BTN_BASE =
...
export const BTN = {
  primary: `${BTN_BASE} bg-electric text-[#F7F8F8] hover:brightness-125 border border-[#85C8FF]/30`,
  accent: `${BTN_BASE} bg-[#85C8FF] text-[#001391] hover:brightness-95`,
  success: `${BTN_BASE} bg-[#88E783] text-[#001391] hover:brightness-95`,
  warn: `${BTN_BASE} bg-[#FFB56B] text-[#001391] hover:brightness-95`,
