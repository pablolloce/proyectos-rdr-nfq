...
const QUES = [
  ...
  {q:"¿A quién va dirigida la confirmación que define una SCIS?",opts:["Al contacto destinatario de la contraparte","Al banco corresponsal que liquida la operación","Al regulador que supervisa la operación","Al sistema de pagos del beneficiario"],c:0,exp:"La SCIS indica el contacto destinatario de la confirmación/notificación en la contraparte (la dimensión '¿a quién?')."},
  ...
  {q:"¿Por qué medios puede enviarse una confirmación según la SCIS?",opts:["Por SWIFT, EMAIL, FAX o plataformas","Solo por SWIFT, nunca por ningún otro medio","Únicamente por correo postal certificado","Por teléfono con grabación de la llamada"],c:0,exp:"El canal (media) de una SCIS puede ser SWIFT, EMAIL, FAX o plataformas electrónicas (FXAll, Markit, Bloomberg…). EMAIL y FAX cubren la mayoría; SWIFT es minoritario."},
  {q:"¿En qué se concentra el uso del canal SWIFT (MT3xx) para confirmar?",opts:["En derivados OTC, repos y renta fija","En todas las operaciones por igual","En los pagos en efectivo en euros","En la confirmación de cuentas internas"],c:0,exp:"SWIFT (MT300/320/360) es minoritario y se concentra en derivados OTC, repos y renta fija; EMAIL y FAX cubren la mayoría de la operativa, de forma manual."},
